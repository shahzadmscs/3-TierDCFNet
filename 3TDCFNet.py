...
from models import i3DesNet
from models.DenseNet import DenseNet_rgb
import copy
import inspect 
...
DenseNet = DenseNet(pretrained=True)
...
class SANet(nn.Module):
  def __init__(self):
    ...
    # encoder
    self.encoder_rgb = DenseNet_rgb()
    self.encoder_fs =I3DenseNet(copy.deepcopy(DenseNet))  
