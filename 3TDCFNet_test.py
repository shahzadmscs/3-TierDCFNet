...
parser.add_argument('--test_path', type=str, default=os.getcwd() + '/dataset/RWBC_for_test/', help='test dataset path')
...
#load the model
model = SANet()
model.load_state_dict(torch.load(os.getcwd() + '/models_test/3TDCFNet.pth'))
model.cuda()
model.eval()
...
for dataset in test_datasets:
    save_path = './test_maps/3TDCFNet/DenseNet/' + dataset + '/'
